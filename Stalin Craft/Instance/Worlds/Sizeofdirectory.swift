...
extension FileManager {
    ...
    /// directories, hard links, etc.)
    
    func allocatedSizeOfDirectory(_ directoryURL: URL) throws -> UInt64 {
        
        // Handler stores the error and stops traversal
